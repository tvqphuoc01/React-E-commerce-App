                ...
                <div className='relative m-auto'>
                    ...
                    <div className='absolute inset-x-0 bottom-0 min-h-1/3 min-w-full flex'>
                        ...
                        <div className='flex items-center'>
                            <button className="bg-white hover:bg-[#445f84] hover:text-white text-[#445f84] font-bold lg:ml-3 lg:mb-3 lg:py-2 lg:px-4 md:ml-2 md:mb-2 md:py-1 md:px-2 rounded-full">
